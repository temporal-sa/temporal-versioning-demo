...
- [Kubernetes namespace: pizza-tracker](references/k8s-namespace.md) — demo deploys to a dedicated `pizza-tracker` namespace owned by Kustomize; backend derives `PIZZA_DEPLOYMENT_NAME=$(POD_NAMESPACE)/pizza-worker` via the Downward API.
